...
\noindent \textbf{\large\color{pn-primary} IT} \\
...
\noindent \textbf{\large\color{pn-primary} HR} \\
...
\noindent \textbf{\large\color{pn-primary} Design \& Marketing} \\
...
\noindent \textbf{\large\color{pn-primary} Events \& Partnerships} \\
...
\begin{center}
    ...
    \textcolor{pn-text-secondary}{\small PoliNetwork APS — Ente del Terzo Settore}\\
    \textcolor{pn-text-secondary}{\small Sede legale: Milano}\\
    \textcolor{pn-text-secondary}{\small Tutti i progetti software sono rilasciati con licenza open source}
\end{center}
